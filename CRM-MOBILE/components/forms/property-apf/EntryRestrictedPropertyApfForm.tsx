...
import {
  ...
  FinalStatus, TaskStatus, CapturedImage, TPCMetPerson
} from '../../../types';
...
const EntryRestrictedPropertyApfForm: React.FC<EntryRestrictedPropertyApfFormProps> = ({ taskData }) => {
  ...
  const { updateEntryRestrictedPropertyApfReport, toggleSaveTask , fetchTasks } = useTasks();
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    updateEntryRestrictedPropertyApfReport(taskData.id, updates);
  };
