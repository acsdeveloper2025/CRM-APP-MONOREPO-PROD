...
import {
  VerificationTask, EntryRestrictedBusinessReportData, AddressLocatable, AddressRating, MetPersonErt, TPCConfirmation,
...
const EntryRestrictedBusinessForm: React.FC<EntryRestrictedBusinessFormProps> = ({ taskData }) => {
  ...
  const { updateEntryRestrictedBusinessReport, toggleSaveTask , fetchTasks } = useTasks();
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    updateEntryRestrictedBusinessReport(taskData.id, updates);
  };
