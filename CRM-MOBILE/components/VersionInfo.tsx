...
const RefreshCw = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
  </svg>
);

const Download = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const SmartphoneIcon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a1 1 0 001-1V4a1 1 0 00-1-1H8a1 1 0 00-1 1v16a1 1 0 001 1z" />
  </svg>
);

const InfoIcon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);

const CheckCircle2Icon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);

const AlertTriangleIcon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z" />
  </svg>
);

const CalendarIcon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
  </svg>
);

const HashIcon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14" />
  </svg>
);
// Additional icon components
const GlobeIcon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const SettingsIcon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const EyeIcon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
...
const ClockIcon = ({ className, width, height, color }: { className?: string; width?: number; height?: number; color?: string }) => (
  <svg className={className} width={width} height={height} color={color} fill="none" stroke="currentColor" viewBox="0 0 24 24">
