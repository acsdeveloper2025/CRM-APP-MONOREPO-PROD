...
class CaseStatusService {
  ...
  private static getApiBaseUrl(): string {
    ...
    if (isLocalhost) {
      ...
      const url = import.meta.env.VITE_API_BASE_URL_DEVICE || 'http://PUBLIC_STATIC_IP:3000/api';
      ...
      const url = import.meta.env.VITE_API_BASE_URL_STATIC_IP || 'http://PUBLIC_STATIC_IP:3000/api';
