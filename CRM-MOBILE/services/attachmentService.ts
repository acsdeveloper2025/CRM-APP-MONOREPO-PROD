...
class AttachmentService {
  ...
  private getApiBaseUrl(): string {
    console.log('🔍 Attachment Service - API Configuration');
    ...
    if (isProduction) {
      ...
      console.log('🌍 Attachment Service - Using Production API URL:', productionUrl);
      ...
      console.log('🌍 Attachment Service - Using Development API URL:', devUrl);
      return devUrl;
    }
  }
