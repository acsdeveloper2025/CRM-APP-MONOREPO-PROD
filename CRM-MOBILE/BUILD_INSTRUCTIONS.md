...
1. **Web Deployment** - For accessing via browser at `https://example.com/mobile/`
...
2. **Deploy to production:**
   ...
   scp -r dist/* root@SERVER_IP:/opt/crm-app/current/CRM-MOBILE/dist/
...
3. **Restart PM2:**
   ```bash
   ssh root@SERVER_IP "pm2 restart crm-mobile"
   ```
