...
- Development: `postgresql://acs_user:acs_password@localhost:5432/acs_db`
- Production: `postgresql://acs_user:acs_password@localhost:5432/acs_db` (same credentials)
...
ssh -p 2232 root@49.50.119.155 \
  "PGPASSWORD=acs_password psql -h localhost -p 5432 -U acs_user -d acs_db -c '\dt schema_migrations'"
```
...
- **Development:** `postgresql://acs_user:acs_password@localhost:5432/acs_db`
- **Production:** `postgresql://acs_user:acs_password@localhost:5432/acs_db`
