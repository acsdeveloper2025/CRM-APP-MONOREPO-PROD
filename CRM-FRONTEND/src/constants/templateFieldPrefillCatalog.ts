...
// -----------------------------------------------------------------------------
// Mirrors CRM-BACKEND/src/config/templateFieldPrefillCatalog.ts.
//
// EVERY entry has been cross-checked against the frontend UI — it is
// visible on at least one page (Case Detail, New Case, Task Detail).
// Fields that exist in the DB but are NOT shown anywhere are excluded.
// -----------------------------------------------------------------------------
 ...
 * upload. The admin explicitly picks mappings via the dropdown.
 */
