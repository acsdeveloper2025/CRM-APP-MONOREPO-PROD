...
export const PERMISSIONS = {
  ...
  VERIFICATION_TYPES: {
    CREATE: 'verificationTypes.create',
    READ: 'verificationTypes.read',
    UPDATE: 'verificationTypes.update',
    DELETE: 'verificationTypes.delete',
  },
  DOCUMENT_TYPES: {
    CREATE: 'documentTypes.create',
    READ: 'documentTypes.read',
    UPDATE: 'documentTypes.update',
    DELETE: 'documentTypes.delete',
  },
  RATE_MANAGEMENT: {
    CREATE: 'rateManagement.create',
    READ: 'rateManagement.read',
    UPDATE: 'rateManagement.update',
    DELETE: 'rateManagement.delete',
  },
  COMMISSIONS: {
...
export const RESOURCES = {
  ...
  RATE_MANAGEMENT: 'rateManagement',
