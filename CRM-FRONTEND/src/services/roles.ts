...
const DEFAULT_LEGACY_PERMISSIONS: RolePermissions = {
  ...
  verificationTypes: { create: false, read: false, update: false, delete: false },
  documentTypes: { create: false, read: false, update: false, delete: false },
  rateManagement: { create: false, read: false, update: false, delete: false },
