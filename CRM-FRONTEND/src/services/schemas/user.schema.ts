...
export const UserSchema = z
  .object({
    ...
    // PG COUNT(...) aggregates arrive as JS strings (bigint precision); coerce.
    assignedClientsCount: z.coerce.number().optional(),
    assignedProductsCount: z.coerce.number().optional(),
    assignedPincodesCount: z.coerce.number().optional(),
    assignedAreasCount: z.coerce.number().optional(),
