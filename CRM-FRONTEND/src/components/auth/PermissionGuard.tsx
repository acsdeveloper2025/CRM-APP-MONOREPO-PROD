...
export function PermissionGuard({ children, resource, action, fallback, showError = false, }: PermissionGuardProps) {
...
export function MultiplePermissionGuard({ children, permissions, requireAll = true, fallback, showError = false, }: MultiplePermissionGuardProps) {
