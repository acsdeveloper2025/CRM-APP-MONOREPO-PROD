    ...
    <div {...{ className: 'space-y-6' }}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Status of push notification services</CardDescription>
        </CardHeader>
        <CardContent>
          {connectivity ? (
            <div {...{ className: 'grid grid-cols-1 md:grid-cols-2 gap-4' }}>
              ...
              <div {...{ className: 'flex items-center space-x-3' }}>
                ...
                <div>
                  ...
                  <p {...{ className: 'text-sm text-gray-600' }}>iOS push notifications</p>
                </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Performance metrics and delivery statistics</CardDescription>
        </CardHeader>
        <CardContent>
          {analytics ? (
            <div {...{ className: 'space-y-6' }}>
