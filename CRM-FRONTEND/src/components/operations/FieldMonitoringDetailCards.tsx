...
export const FieldMonitoringDetailCards = React.memo(function FieldMonitoringDetailCards({ detail, formatTimestamp, getMobileDisplay, statusBadgeClassNames, }: FieldMonitoringDetailCardsProps) {
    return (<>
      <Card>
      ...
      <div {...{ className: "grid gap-6 xl:grid-cols-2" }}>
        ...
        <Card>
          ...
          <CardContent>
            {detail.openAssignments.length === 0 ? (<p {...{ className: "text-sm text-gray-600" }}>No open assignments.</p>) : (<div {...{ className: "space-y-3" }}>
                {detail.openAssignments.map((assignment) => (<div key={assignment.task.id} {...{ className: "rounded-lg border border-gray-200 p-3" }}>
