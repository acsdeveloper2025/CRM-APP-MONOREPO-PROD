...
export function TATMonitoringSummaryCards({
  criticalCount,
  totalCount,
  onTrack,
  avgOverdueDays,
...
export function TATMonitoringTable({
  tasks,
  isLoading,
  pagination,
  sortBy,
      ...
      <div className="ui-operational-table" data-density="compact">
        ...
        <div className="ui-operational-table__scroll">
          <table>
            ...
            <tbody>
              {tasks.map((task) => (
                <tr key={task.id} className="ui-operational-row" data-risk={task.daysOverdue > 3 || task.priority === 'URGENT'}>
                  <td>
                    <Stack gap={1}>
