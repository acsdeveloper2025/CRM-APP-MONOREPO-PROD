...
export function KYCRatesTab() {
  ...
  const { data: ratesData, isLoading: ratesLoading } = useQuery({
    queryKey: ['kyc-rates', selectedClientId, selectedProductId, currentPage, pageSize],
    queryFn: () =>
      kycRatesService.getKYCRates({
  ...
  const saveRateMutation = useMutationWithInvalidation({
    ...
    invalidateKeys: [['kyc-rates'], ['rate-management-stats']],
