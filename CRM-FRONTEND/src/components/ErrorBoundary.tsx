            ...
            <Card tone="strong" staticCard style={{ maxWidth: '48rem', margin: '8vh auto 0' }}>
              <Stack gap={6} style={{ textAlign: 'center' }}>
                ...
                <div {...{ className: 'bg-slate-100/70 dark:bg-slate-800/50 rounded-lg p-4' }}>
                  <Text as="h4" variant="title" {...{ className: 'mb-2' }}>
                    Error Details
                  </Text>
                ...
                <Collapsible open={this.state.showDetails} onOpenChange={this.toggleDetails}>
                  ...
                  <CollapsibleContent>
                    <div {...{ className: 'mt-4 space-y-4' }}>
                      <div>
                        <Text as="h5" variant="label" {...{ className: 'mb-2' }}>
                          Error Stack
                        </Text>
                        <pre
                          {...{
                            className:
                              'bg-slate-100 dark:bg-slate-800/60 p-3 rounded text-xs overflow-auto max-h-32',
                          }}
                        >
                      ...
                      <div>
                        ...
                        <div
                          {...{
                            className:
                              'bg-slate-100 dark:bg-slate-800/60 p-3 rounded text-xs space-y-1',
                          }}
                        >
