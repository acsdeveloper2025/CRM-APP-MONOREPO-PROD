...
export const FormValidationStatus: React.FC = () => {
    ...
    return (<div {...{ className: "space-y-4 sm:space-y-6" }}>
      ...
      {hasData && (<Card>
          ...
          <ResponsiveContainer width="100%" height={300} {...{ className: "sm:h-[400px]" }}>
            <AreaChart data={trendData}>
              ...
              <Legend />
              <Area type="monotone" dataKey="valid" stackId="1" stroke={VALIDATION_COLORS.valid} fill={VALIDATION_COLORS.valid} fillOpacity={0.8}/>
              <Area type="monotone" dataKey="pending" stackId="1" stroke={VALIDATION_COLORS.pending} fill={VALIDATION_COLORS.pending} fillOpacity={0.8}/>
              <Area type="monotone" dataKey="invalid" stackId="1" stroke={VALIDATION_COLORS.invalid} fill={VALIDATION_COLORS.invalid} fillOpacity={0.8}/>
            </AreaChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>)}
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={250} {...{ className: "sm:h-[300px]" }}>
            <LineChart data={trendData}>
              ...
              <XAxis dataKey="date"/>
              <YAxis domain={[0, 100]}/>
              <Tooltip formatter={(value) => [`${value}%`, 'Validation Rate']}/>
              <Line type="monotone" dataKey="validationRate" stroke={VALIDATION_COLORS.valid} strokeWidth={3} dot={{ fill: VALIDATION_COLORS.valid, strokeWidth: 2, r: 4 }}/>
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>)}
      ...
      {hasData && (<Card>
        ...
        <CardContent>
          {byFormType.length > 0 ? (<div {...{ className: "space-y-4" }}>
              ...
              <div {...{ className: "grid gap-4 md:grid-cols-3" }}>
                {byFormType.map((formType) => {
                    const validationRate = formType.total_forms > 0
                        ...
                        : 0;
                    return (<div key={formType.form_type} {...{ className: "p-4 border rounded-lg" }}>
