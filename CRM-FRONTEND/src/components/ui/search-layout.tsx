  ...
  return (
    <div className={cn("space-y-4", className)}>
      ...
      <div className={cn(
        ...
        <div className={cn(
          "w-full",
          stackOnMobile ? "sm:w-auto sm:flex-1 sm:max-w-md" : "flex-1 max-w-md"
        )}>
          <SearchInput
            {...searchProps}
            size={searchSize}
        ...
        {actions && (
          <div className={cn(
            "flex gap-2",
            stackOnMobile ? "w-full sm:w-auto" : "w-auto"
          )}>
            {actions}
          </div>
        )}
...
export const SearchWithActions: React.FC<SearchWithActionsProps> = ({
  actions,
  stackOnMobile = true,
  className,
  ...searchProps
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        "w-full",
        stackOnMobile ? "sm:flex-1 sm:max-w-md" : "flex-1 max-w-md"
      )}>
        <SearchInput {...searchProps} className="w-full" />
      </div>
...
export const TabSearchLayout: React.FC<TabSearchLayoutProps> = ({
  searchProps,
  tabs,
  actions,
  filters,
