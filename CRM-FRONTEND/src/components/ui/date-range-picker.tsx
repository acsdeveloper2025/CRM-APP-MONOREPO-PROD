    ...
    return (<div {...{ className: cn("grid gap-2", className) }}>
      <Popover>
        <PopoverTrigger asChild>
          <Button id="date" variant={"outline"} {...{ className: cn("w-[300px] justify-start text-left font-normal", !date && "text-gray-600") }}>
        ...
        <PopoverContent {...{ className: "w-auto p-0" }} align="start">
          <Calendar initialFocus mode="range" defaultMonth={date?.from} selected={{ from: date.from, to: date.to }} onSelect={(range) => {
