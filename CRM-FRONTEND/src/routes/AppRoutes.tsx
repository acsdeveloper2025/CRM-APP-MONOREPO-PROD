    ...
    >
      <Routes>
        ...
        <Route element={<AuthenticatedLayout />}>
          ...
          />
          <Route
            path="/user-management/designations"
            element={
              <ProtectedRoute permission="page.users">
                <DesignationsPage />
              </ProtectedRoute>
          ...
          {/* KYC Verification — All + per-status (Pending / Completed) pages */}
          <Route
            ...
            element={
              <ProtectedRoute permission="page.kyc">
                <KYCDashboardPage
                  ...
                  pageTitle="Completed KYC"
                  pageSubtitle="KYC documents that have been verified"
                />
              </ProtectedRoute>
            }
          />
