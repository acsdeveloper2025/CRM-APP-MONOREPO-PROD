...
export const AwaitingReviewTasksPage: React.FC = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Awaiting Review</h1>
          <p className="text-sm text-muted-foreground">
            Field verifications submitted by field executives, awaiting a backend reviewer&apos;s
            final decision.
          </p>
        </div>
      </div>
