...
const SORT_OPTIONS: Array<{
  ...
  { value: 'assignedAt_desc', label: 'Recently assigned', sortBy: 'assignedAt', sortOrder: 'desc' },
  { value: 'taskNumber_asc', label: 'Task # (A → Z)', sortBy: 'taskNumber', sortOrder: 'asc' },
];

const PENDING_STATUS = 'PENDING,ASSIGNED';
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-muted-foreground">Assigned, Not Started</p>
                <p className="text-2xl font-bold">{stats?.assigned ?? '—'}</p>
                <p className="text-xs text-muted-foreground">Status = ASSIGNED</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-muted-foreground">Aging &gt; 3 days</p>
                <p className="text-2xl font-bold">{stats?.agingOver3Days ?? '—'}</p>
                <p className="text-xs text-muted-foreground">Open &amp; created &gt; 3 days ago</p>
              </div>
            </div>
          </CardContent>
        </Card>
