...
import { Plus, FileCheck, CheckCircle, XCircle, Layers } from 'lucide-react';
  ...
  return (
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        ...
        {/* P19.E-2b: removed "With Rates" stat card. Counted from
            verificationTypes.filter() on the paginated array, so the
            value shifted as the user paginated and was never the
            global rate-mapped total. Add a /api/verification-types/stats
            with_rates_count aggregate if needed. */}
      </div>
