...
**Server:** crm.allcheckservices.com (49.50.119.155)  
...
```
✅ Backend accessible via Nginx:  https://crm.allcheckservices.com/api/health
✅ Frontend accessible via Nginx: https://crm.allcheckservices.com/
✅ Mobile accessible via Nginx:   https://crm.allcheckservices.com/mobile/
...
Internet User
    ↓
https://crm.allcheckservices.com (Port 443 - HTTPS)
    ↓
Nginx Reverse Proxy
    ↓
┌───────────┬────────────┬────────────┐
...
ssh -p 2232 root@49.50.119.155 "sudo reboot"
```
...
Backend:   https://crm.allcheckservices.com/api/
