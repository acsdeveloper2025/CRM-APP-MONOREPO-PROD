...
PROD_SERVER="root@49.50.119.155"
PROD_PORT="2232"
...
PGPASSWORD=acs_password pg_restore -h localhost -U acs_user -d acs_db /tmp/dev_db.dump 2>&1 | tail -20
...
echo ""
echo "Next steps:"
echo "1. Verify health: curl https://crm.allcheckservices.com/api/health"
echo "2. Test web app: https://crm.allcheckservices.com/"
echo "3. Test mobile app: https://crm.allcheckservices.com/mobile/"
