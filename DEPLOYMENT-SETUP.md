...
| `PRODUCTION_HOST` | Production server IP or domain | `49.50.119.155` or `crm.allcheckservices.com` |
...
```bash
ssh-copy-id -i ~/.ssh/github_actions_key.pub admin1@49.50.119.155
```
...
CORS_ORIGIN=https://crm.allcheckservices.com,https://49.50.119.155
```
...
**CRM-MOBILE/.env:**
```env
VITE_API_BASE_URL_STATIC_IP=https://crm.allcheckservices.com/api
VITE_NODE_ENV=production
```
...
- **Main Health**: https://crm.allcheckservices.com/health
- **API Health**: https://crm.allcheckservices.com/api/health
...
4. **Database Connection Failed**
   ...
   - Test connection manually: `psql -h localhost -U acs_user -d acs_db`
