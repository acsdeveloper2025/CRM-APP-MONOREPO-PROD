...
# 🔒 SSL Certificate Setup Script for crm.allcheckservices.com
...
print_info "🔒 SSL Certificate Setup for crm.allcheckservices.com"
echo "======================================================"

# Step 1: Check DNS resolution
print_info "Step 1: Checking DNS resolution..."
if nslookup crm.allcheckservices.com | grep -q "103.14.234.36"; then
    print_status "DNS is correctly configured and pointing to 103.14.234.36"
else
    print_warning "DNS may not be fully propagated yet."
    print_info "Please ensure your DNS A record is set:"
    print_info "  Type: A"
    print_info "  Name: crm"
    print_info "  Value: 103.14.234.36"
    print_info "  TTL: 300"
    echo ""
...
if sudo certbot certonly --standalone \
    -d crm.allcheckservices.com \
    -d www.crm.allcheckservices.com \
...
sudo sed -i 's|ssl_certificate /etc/ssl/certs/crm-selfsigned.crt;|ssl_certificate /etc/letsencrypt/live/crm.allcheckservices.com/fullchain.pem;|' /etc/nginx/sites-available/crm.allcheckservices.com
sudo sed -i 's|ssl_certificate_key /etc/ssl/private/crm-selfsigned.key;|ssl_certificate_key /etc/letsencrypt/live/crm.allcheckservices.com/privkey.pem;|' /etc/nginx/sites-available/crm.allcheckservices.com
...
sleep 5
if curl -s -I https://crm.allcheckservices.com | grep -q "HTTP/2 200\|HTTP/1.1 200"; then
...
print_info "  • https://crm.allcheckservices.com"
print_info "  • https://www.crm.allcheckservices.com"
echo ""
