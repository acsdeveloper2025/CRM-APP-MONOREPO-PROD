...
PGPASSWORD=example_db_password pg_restore -h localhost -U example_db_user -d acs_db /tmp/dev_db.dump
redis-cli FLUSHALL
...
echo ""
echo "Test URLs:"
echo "- API: https://example.com/api/health"
echo "- Web: https://example.com/"
echo "- Mobile: https://example.com/mobile/"
