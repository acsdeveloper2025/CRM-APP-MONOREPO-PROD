-- =====================================================
-- MIGRATION 005: FIX MIGRATION FUNCTION
-- =====================================================
-- This migration fixes the data migration function to use the correct
-- commission amount lookup from the rates table.

-- Drop and recreate the migration function with correct rate lookup
