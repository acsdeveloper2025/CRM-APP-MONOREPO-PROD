...
const VALID_OUTCOMES: Record<string, string[]> = {
  ...
  BUILDER: ['POSITIVE', 'NEGATIVE', 'HOLD'],
  NOC: ['POSITIVE', 'NEGATIVE'],
  DSA_CONNECTOR: ['POSITIVE', 'NEGATIVE'],
  PROPERTY_APF: ['POSITIVE', 'NEGATIVE', 'HOLD'],
  PROPERTY_INDIVIDUAL: ['POSITIVE', 'NEGATIVE', 'HOLD'],
};
