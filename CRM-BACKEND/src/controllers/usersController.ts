...
import { PRIMARY_RBAC_ROLE_NAME_SQL, buildUsersWhereClause } from './users/queryBuilder';
...
// User-sessions handlers (list / stats / export) live in ./users/sessions.
...
// Password-management handlers (generate-temp / change / reset) live in
// ./users/passwords. Re-exported so routes/users.ts is untouched.
