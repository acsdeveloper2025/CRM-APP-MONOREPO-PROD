/**
 * NOC Form Data Preparation
 *
 * Maps mobile form payload → DB columns and ensures every column is populated
 * (with null defaults via ensureAllNocFieldsPopulated). Required-field gating
 * lives in the mobile FormValidationEngine; backend is permissive observability.
 */
...
/**
 * Maps mobile NOC form data to database columns and fills defaults.
 *
