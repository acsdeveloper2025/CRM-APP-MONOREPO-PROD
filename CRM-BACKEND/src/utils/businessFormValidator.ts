/**
 * Business Form Data Preparation
 *
 * Maps mobile form payload → DB columns and ensures every column is populated
 * (with null defaults via ensureAllBusinessFieldsPopulated). Required-field
...
/**
 * Maps mobile business form data to database columns and fills defaults.
 *
