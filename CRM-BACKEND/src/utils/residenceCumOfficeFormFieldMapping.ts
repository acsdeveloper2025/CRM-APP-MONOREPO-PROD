...
const RELEVANT_FIELDS_BY_TYPE: Readonly<Record<string, readonly string[]>> = {
  ...
  SHIFTED: [
    ...
    'landmark1',
    'landmark2',
    // met_person_name removed: conditional on resiCumOfficeStatus='Open'; SHIFTED Door Locked has none
    // company_name_plate_status + name_on_board removed: RCO SHIFTED mobile form doesn't capture (POSITIVE only)
    'shifted_period',
    'political_connection',
    'dominated_area',
    'feedback_from_neighbour',
  ...
  NSP: [
    ...
    'landmark1',
    'landmark2',
    // met_person_name removed: conditional on resiCumOfficeStatus='Open'; NSP Door Locked has none
    // company_name_plate_status + name_on_board removed: RCO NSP mobile form doesn't capture (POSITIVE only)
    'political_connection',
    'dominated_area',
    'feedback_from_neighbour',
    'other_observation',
  ...
  ENTRY_RESTRICTED: [
    ...
    'landmark1',
    'landmark2',
    // address_floor / company_name_plate_status / name_on_board removed:
    // RCO ERT mobile form doesn't capture these (POSITIVE only).
