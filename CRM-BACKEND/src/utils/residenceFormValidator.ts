/**
 * Residence Form Data Preparation
 *
 * Maps mobile form payload → DB columns and ensures every column is populated
 * (with null defaults via ensureAllFieldsPopulated). Required-field gating lives
 * in the mobile FormValidationEngine; backend is permissive observability.
 */
...
/**
 * Maps mobile residence form data to database columns and fills defaults.
 *
