...
const PROPERTY_APF_FORM_FIELDS: FormFieldDefinition[] = [
  ...
  {
    id: 'metPersonContact',
    name: 'metPersonContact',
    label: 'Met Person Contact',
    type: 'text',
    isRequired: false,
    section: 'Basic Information',
    order: 6,
  ...
  {
    id: 'apfIssuingAuthority',
    name: 'apfIssuingAuthority',
    label: 'APF Issuing Authority',
    type: 'text',
    isRequired: false,
    section: 'APF Details',
    order: 5,
  ...
  {
    id: 'apfValidityStatus',
    name: 'apfValidityStatus',
    label: 'APF Validity Status',
    type: 'text',
    isRequired: false,
    section: 'APF Details',
    order: 6,
  ...
  {
    id: 'apfUtilizedAmount',
    name: 'apfUtilizedAmount',
    label: 'APF Utilized Amount',
    type: 'number',
    isRequired: false,
    section: 'APF Details',
    order: 8,
  ...
  {
    id: 'apfBalanceAmount',
    name: 'apfBalanceAmount',
    label: 'APF Balance Amount',
    type: 'number',
    isRequired: false,
    section: 'APF Details',
    order: 9,
  ...
  {
    id: 'totalFlatsInBuilding',
    name: 'totalFlatsInBuilding',
  ...
  {
    id: 'propertyConcerns',
    name: 'propertyConcerns',
    label: 'Property Concerns',
    type: 'textarea',
    isRequired: false,
    section: 'Infrastructure & Area Assessment',
    order: 7,
...
const PROPERTY_INDIVIDUAL_FORM_FIELDS: FormFieldDefinition[] = [
  ...
  {
    id: 'individualOccupation',
    name: 'individualOccupation',
    label: 'Individual Occupation',
    type: 'text',
    isRequired: false,
    section: 'Individual Information',
    order: 3,
  ...
  {
    id: 'individualEducation',
    name: 'individualEducation',
  ...
  },
  {
    ...
    name: 'individualMaritalStatus',
    label: 'Individual Marital Status',
    type: 'text',
    isRequired: false,
    section: 'Individual Information',
    order: 5,
  ...
  {
    id: 'neighbor1Confirmation',
    name: 'neighbor1Confirmation',
    label: 'Neighbor 1 Confirmation',
    type: 'text',
    isRequired: false,
    section: 'Third Party Confirmation',
    order: 8,
  ...
  {
    id: 'neighbor2Confirmation',
    name: 'neighbor2Confirmation',
    label: 'Neighbor 2 Confirmation',
    type: 'text',
    isRequired: false,
    section: 'Third Party Confirmation',
    order: 10,
  ...
  {
    id: 'localityReputation',
    name: 'localityReputation',
    label: 'Locality Reputation',
    type: 'text',
    isRequired: false,
...
const NOC_FORM_FIELDS: FormFieldDefinition[] = [
  ...
  {
    id: 'nocIssuingAuthority',
    name: 'nocIssuingAuthority',
    label: 'NOC Issuing Authority',
    type: 'text',
    isRequired: false,
    section: 'NOC Information',
    order: 6,
  ...
  {
    id: 'nocValidityStatus',
    name: 'nocValidityStatus',
    label: 'NOC Validity Status',
    type: 'text',
    isRequired: false,
    section: 'NOC Information',
    order: 7,
  ...
  // Builder & Developer Information
  {
    ...
    type: 'text',
    isRequired: false,
    section: 'Builder & Developer Information',
    order: 1,
  },
  {
    id: 'builderContact',
  ...
  // Clearances & Compliance
  {
    ...
    type: 'text',
    isRequired: false,
    section: 'Clearances & Compliance',
    order: 1,
  },
  {
    id: 'fireSafetyClearance',
    name: 'fireSafetyClearance',
  ...
  {
    id: 'waterConnectionStatus',
    name: 'waterConnectionStatus',
    label: 'Water Connection Status',
    type: 'text',
    isRequired: false,
    section: 'Clearances & Compliance',
    order: 4,
  ...
  {
    id: 'electricityConnectionStatus',
    name: 'electricityConnectionStatus',
    label: 'Electricity Connection Status',
    type: 'text',
    isRequired: false,
    section: 'Clearances & Compliance',
    order: 5,
...
const DSA_CONNECTOR_FORM_FIELDS: FormFieldDefinition[] = [
  ...
  {
    id: 'connectorDesignation',
    name: 'connectorDesignation',
  ...
  {
    id: 'connectorExperience',
    name: 'connectorExperience',
    label: 'Connector Experience',
    type: 'number',
    isRequired: false,
    section: 'Connector Information',
    order: 5,
  ...
  // Financial Information
  {
    id: 'monthlyBusinessVolume',
    name: 'monthlyBusinessVolume',
    label: 'Monthly Business Volume',
    type: 'number',
    isRequired: false,
    section: 'Financial Information',
    order: 1,
  ...
  // Market Analysis & Assessment
  {
    ...
    type: 'text',
    isRequired: false,
    section: 'Market Analysis & Assessment',
    order: 1,
  },
  {
