...
// 2026-04-27 F9+F10 catalog cleanup (per project_form_field_mapping_drift_audit.md):
//   Mobile SSOT = legacyPositive/Shifted/Nsp/EntryRestricted/Untraceable PropertyApfFields.
//   Removed 14 stale entries (not in mobile SSOT): metPersonRelation, addressStructure,
//   addressStructureColor, addressFloor, doorColor, propertyStatus, propertyArea,
//   documentShownStatus, documentType, shiftedPeriod, premisesStatus, securityConfirmation,
//   projectStartDate, projectEndDate, projectCompletionPercentage.
//   Added 6 missing entries: constructionActivity (kept), activityStopReason,
//   projectCompletionPercent (canonical), metPersonType (ERT), metPersonConfirmation
//   (ERT), finalStatusNegative.
...
// 2026-04-27 F3 PI catalog rewrite (per project_form_field_mapping_drift_audit.md):
//   Mobile SSOT = legacyPositive/Nsp/EntryRestricted/Untraceable PropertyIndividualFields.
//   Removed 12 stale entries (not in mobile SSOT): metPersonDesignation, metPersonRelation,
//   addressFloor, propertyStatus, propertyArea, ownerName, familyMembers, businessName,
//   businessType, shiftedPeriod, premisesStatus, securityConfirmation.
//   Added 10 missing canonical mobile entries: buildingStatus, flatStatus, relationship,
//   propertyOwnerName, approxArea, addressExistAt, doorNamePlateStatus, nameOnDoorPlate,
//   societyNamePlateStatus, nameOnSocietyBoard.
