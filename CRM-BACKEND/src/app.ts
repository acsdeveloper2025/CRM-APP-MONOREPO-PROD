...
apiRouter.use('/verification-type-outcomes', verificationTypeOutcomesRoutes);
apiRouter.use('/document-types', documentTypesRoutes);
apiRouter.use('/kyc-rates', kycRatesRoutes);
...
apiRouter.use('/reverse-geocode-dlq', reverseGeocodeDlqRoutes);
