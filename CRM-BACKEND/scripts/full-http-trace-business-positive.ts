...
async function main() {
  ...
  const v1Db: Record<string, boolean> = {
    ...
    'name_on_company_board=BIZ-V1-NAME': row1.name_on_company_board === 'BIZ-V1-NAME',
  ...
  const v2Db: Record<string, boolean> = {
    ...
    'V2 name_on_company_board=BIZ-V2-NAME': row2.name_on_company_board === 'BIZ-V2-NAME',
  ...
  const renderChecks: Record<string, boolean> = {
    ...
    'V2 name_on_company_board in report': report.includes('BIZ-V2-NAME'),
    'V1 name_on_company_board absent': !report.includes('BIZ-V1-NAME'),
