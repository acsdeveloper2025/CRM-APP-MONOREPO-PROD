...
ssh -p 2232 root@49.50.119.155 "cd /opt/crm-app/current/CRM-BACKEND && npm run migrate:status"

# View deployment logs
ssh -p 2232 root@49.50.119.155 "tail -100 /var/log/crm-app/deployment.log | grep -A 20 'Running Database Migrations'"
```
