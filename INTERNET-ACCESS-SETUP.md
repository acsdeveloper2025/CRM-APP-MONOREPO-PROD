...
## 📋 Overview
This guide helps you configure your CRM system for internet access using your static IP address `PUBLIC_STATIC_IP`.
...
- **Option 2**: Internet Access via Static IP (PUBLIC_STATIC_IP)
...
- **Frontend Web App**: http://PUBLIC_STATIC_IP:5173
- **Mobile Web App**: http://PUBLIC_STATIC_IP:5180
- **Backend API**: http://PUBLIC_STATIC_IP:3000
...
1. **Static IP Priority**: http://PUBLIC_STATIC_IP:3000/api
...
3. Test API directly: `curl http://PUBLIC_STATIC_IP:3000/api/health`
...
2. **Test Internet Access:**
   ```bash
   curl http://PUBLIC_STATIC_IP:3000/api/health
   ```

3. **Test Frontend:**
   - Open http://PUBLIC_STATIC_IP:5173 in browser
   - Login should work normally
   - All features should be accessible

4. **Test Mobile:**
   - Open http://PUBLIC_STATIC_IP:5180 in mobile browser
